...
def test_basic_imports():
    ...
    from ax_utils.ax_queue import AXQueue, Full, Empty
    ...
    from ax_utils.unicode_utils import encode_nested, decode_nested, is_utf8
...
def test_unicode_utils_functionality():
    ...
    from ax_utils.unicode_utils import is_utf8, encode_nested, decode_nested
